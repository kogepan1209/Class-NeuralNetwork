...
if __name__ == '__main__':
    ...
    # 順方向の同定システムのグラフ描画
    draw_identification_graph("Forward Identification System", y_list, forward_ynn_list,
                              sys_label_name="y", nn_label_name="ynn", start_k=start_k, end_k=end_k, hide_node=hide_node, lr=lr)
    draw_identification_graph("Forward Identification System", y_list, forward_ynn_list,
                              sys_label_name="y", nn_label_name="ynn", start_k=4900, end_k=5000, hide_node=hide_node, lr=lr)

    # 逆方向の同定システムのグラフ描画
    draw_identification_graph("Reverse Identification System", u_list, reverse_ynn_list,
                              sys_label_name="u", nn_label_name="ynn", start_k=start_k, end_k=end_k, hide_node=hide_node, lr=lr)
    draw_identification_graph("Reverse Identification System", u_list, reverse_ynn_list,
                              sys_label_name="u", nn_label_name="ynn", start_k=4900, end_k=5000, hide_node=hide_node, lr=lr)
